...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/1 cls/my.data', help='*.data path')
    parser.add_argument('--weights', type=str, default='weights/5 cls/best.pt', help='weights path')
