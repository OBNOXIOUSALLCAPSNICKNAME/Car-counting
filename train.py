...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='datasets/cars 1/yolov3.cfg', help='*.cfg path')
    parser.add_argument('--data', type=str, default='datasets/cars 1/yolov3.data', help='*.data path')
